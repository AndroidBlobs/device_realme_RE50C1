...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/audio_platform_info_coco.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info_coco.xml \
    ...
    $(LOCAL_PATH)/configs/audio/audio_platform_info_rum.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info_rum.xml \
    ...
    $(LOCAL_PATH)/configs/audio/audio_platform_info_soda.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info_soda.xml \
    ...
    $(LOCAL_PATH)/configs/audio/mixer_paths_coco.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_coco.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_qrd.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_qrd.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_qrd_rum.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_qrd_rum.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_qrd_soda.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_qrd_soda.xml \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/wifi/bdwlan_20670_id0.bin:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/bdwlan_20670_id0.bin \
    $(LOCAL_PATH)/configs/wifi/bdwlan_20671_id0.bin:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/bdwlan_20671_id0.bin \
    $(LOCAL_PATH)/configs/wifi/bdwlan_20672_id0.bin:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/bdwlan_20672_id0.bin \
    $(LOCAL_PATH)/configs/wifi/bdwlan_20673_id0.bin:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/bdwlan_20673_id0.bin \
    $(LOCAL_PATH)/configs/wifi/bdwlan_20674_id0.bin:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/bdwlan_20674_id0.bin \
    $(LOCAL_PATH)/configs/wifi/bdwlan_20675_id0.bin:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/bdwlan_20675_id0.bin \
    $(LOCAL_PATH)/configs/wifi/bdwlan_20676_id0.bin:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/bdwlan_20676_id0.bin \
    $(LOCAL_PATH)/configs/wifi/bdwlan_20677_id0.bin:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/bdwlan_20677_id0.bin \
    $(LOCAL_PATH)/configs/wifi/bdwlan_20679_id0.bin:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/bdwlan_20679_id0.bin \
    $(LOCAL_PATH)/configs/wifi/bdwlan_2067A_id0.bin:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/bdwlan_2067A_id0.bin \
    $(LOCAL_PATH)/configs/wifi/bdwlan_2067C_id0.bin:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/bdwlan_2067C_id0.bin \
    $(LOCAL_PATH)/configs/wifi/bdwlan_2067D_id0.bin:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/bdwlan_2067D_id0.bin \
    ...
    $(LOCAL_PATH)/configs/wifi/regBin_version:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/regBin_version \
...
# Inherit vendor
$(call inherit-product, vendor/realme/RE50C1/RE50C1-vendor.mk)